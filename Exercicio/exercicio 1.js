...
const recebePessoa = require('./recebePessoas');

    describe('Teste checando quantos itens tem', () => {
    const valorEsperado = 3;
        it('teste de verificação de quantidade de pessoas no array', (valorEsperado) => {
        const numero = recebePessoas(pessoas);
        assert.strictEqual(numero,valorEsperado);
    }); 
        }) 
        */